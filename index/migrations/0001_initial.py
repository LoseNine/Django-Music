# Generated by Django 2.1 on 2019-05-30 04:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('song_name', models.CharField(max_length=50, verbose_name='歌曲')),
        ...
        migrations.AddField(
            model_name='dynamic',
            name='song',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='index.Song', verbose_name='歌曲名字'),
        ),
        migrations.AddField(
            model_name='comment',
            name='song',
